...
import 'package:delicious/search.dart';
              ...
              children: [
                ...
                Container(
                  ...
                  child: const Column(
                    ...
                    children: [
                      Text("WHAT DO YOU WANT TO COOK TODAY?",style:
                      TextStyle(fontSize: 30,fontWeight: FontWeight.bold,color: Colors.white70),),
                      SizedBox(height: 10,),
                      Text("Let's Cook Something New!",style: TextStyle(fontSize: 18,fontWeight: FontWeight.normal,color: Colors.white70),),
                    ],
                  ),
                ),
                Container(
